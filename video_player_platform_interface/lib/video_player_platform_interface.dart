...
abstract class VideoPlayerPlatform {
  ...
  // List qualities
  Future<List<int>> qualities(int textureId) {
    throw UnimplementedError('qualities() has not been implemented.');
  }

  // current quality
  Future<int> currentQuality(int textureId) {
    throw UnimplementedError('currentQuality() has not been implemented.');
  }
