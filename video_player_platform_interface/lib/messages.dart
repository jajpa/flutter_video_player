...
class QualitiesMessage {
  ...
  // ignore: unused_element
  static QualitiesMessage _fromMap(Map<dynamic, dynamic> pigeonMap) {
    final QualitiesMessage result = QualitiesMessage();
    result.textureId = pigeonMap['textureId'];
    result.qualities =
        jsonDecode(pigeonMap['qualities'].toString()).cast<int>();

    //    List<int> qualities = (jsonDecode(response) as List<dynamic>).cast<int>();
...
//          details: error['details']);
  ...
  Future<QualitiesMessage> qualities(QualitiesMessage arg) async {
    print('messages');
    final Map<dynamic, dynamic> requestMap = arg._toMap();
    const BasicMessageChannel<dynamic> channel = BasicMessageChannel<dynamic>(
        'dev.flutter.pigeon.VideoPlayerApi.qualities', StandardMessageCodec());
    ...
    if (replyMap == null) {
      ...
      return QualitiesMessage._fromMap(replyMap['result']);
    }
  }

  Future<QualityMessage> currentQuality(QualityMessage arg) async {
    print('messages');
    final Map<dynamic, dynamic> requestMap = arg._toMap();
    const BasicMessageChannel<dynamic> channel = BasicMessageChannel<dynamic>(
    ...
    if (replyMap == null) {
      ...
      return QualityMessage._fromMap(replyMap['result']);
    }
  }
