...
class MethodChannelVideoPlayer extends VideoPlayerPlatform {
  ...
  Future<void> setQuality(int textureId, int quality) {
    print('method_channel_video_player');
  ...
  @override
  Future<List<int>> qualities(int textureId) async {
    print('method_channel_video_player');
    var response =
    await _api.qualities(QualitiesMessage()..textureId = textureId);
    return response.qualities;
  }

  @override
  Future<int> currentQuality(int textureId) async {
    print('method_channel_video_player');
    var response =
    await _api.currentQuality(QualityMessage()..textureId = textureId);
