...
public class VideoPlayerPlugin implements FlutterPlugin, VideoPlayerApi {
  ...
  public void setQuality(Messages.QualityMessage arg) {
    System.out.println("VideoPlayerPlgin");
    VideoPlayer player = videoPlayers.get(arg.getTextureId());
  ...
  @Override
  public Messages.QualitiesMessage qualities(TextureMessage arg) {
    VideoPlayer player = videoPlayers.get(arg.getTextureId());
    Messages.QualitiesMessage result = new Messages.QualitiesMessage();
    result.setQualities(player.qualities());
    player.qualities();
    return result;
  ...
  @Override
  public Messages.QualityMessage currentQuality(TextureMessage arg) {
    VideoPlayer player = videoPlayers.get(arg.getTextureId());
    Messages.QualityMessage result = new Messages.QualityMessage();
    result.setQuality(player.currentQuality());
    player.qualities();
    return result;
  }
